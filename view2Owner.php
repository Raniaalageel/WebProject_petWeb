...
<nav class="navbar">
  ...
  <div class="icons2" >  
    ...
    <section style="margin-top:-15%" class="section_Body">
      <div class="row">
          
        <h1 style="margin-top:-10%" class="head">My Profile</h1>
      </div>
 ...
 <div style="display:inline;" class="column">
          ...
          <?php foreach($row as $appoi){  ?> 
               ...
               <div class="img-container"> 
                <img style="margin-left:2%; padding-bottom:10%;"  width="270" height="160" alt="could not dawnload" src="data:image/jpeg;base64,<?php echo base64_encode($appoi['img']); ?>"  >  
          
            </div>
            <?php  echo '<br> ';   ?>
                    <p style="font-size:23px;" ><?php echo"First name:" .$appoi['fname'];   ?></p>
                    <p style="font-size:23px;"><?php echo" Last name: " .$appoi['lname'];  ?></p>
                    <p style="font-size:23px;"><?php echo"Gender:" .$appoi['gender'];   ?></p>
                    <p style="font-size:23px;"><?php echo"Email:" .$appoi['email'];   ?></p>
                    <p style="font-size:23px;"><?php echo"phone:" .$appoi['phone'];   ?></p>

                    <div class="icons">
        <a href="updateOwner.php?id=<?php echo $appoi['id']; ?>">Edit <i class="fas fa-pen"></i></a>
        <a onclick="return confirm('Are you sure that you want to delete your account?')" href="deleteOwner.php?id=<?php echo $appoi['id']; ?>" >delete <i class="fas fa-pen"></i></a></div>
