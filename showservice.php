  ...
  <section>
    ...
    <section class="section_Body">
      <div class="row">
        <br>
          <br>
        <h1  style="margin-top:-20% ;"  class="head">Service information:</h1>
      </div>
 ...
 <div style="display:inline;" class="column">
    ...
    <img style="margin-left:2%; padding-bottom:10%;"  width="270" height="160" alt="could not dawnload" src="data:image/jpeg;base64,<?php echo base64_encode($appoi['photo']); ?>"  >  
            ...
            <?php  echo '<br> ';   ?>
                    ...
                    <div class="icons">
        <a onclick="return confirm('Are you sure that you want to Edit this service ?')"href="editService.php?id=<?php echo $appoi['serviceID']; ?>">Edit <i class="fas fa-pen"></i></a>
        <a onclick="return confirm('Are you sure that you want to Delete this service ?')"href="deleteService.php?id=<?php echo $appoi['serviceID']; ?>" >delete <i class="fas fa-pen"></i></a></div>
