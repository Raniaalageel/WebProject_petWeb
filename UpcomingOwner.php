...
$query="SELECT * FROM  (appointment JOIN Pet ON Pet.id=appointment.PetID) WHERE status='yes' AND Owneremail='$email2'";
...
<html lang="en">
  ...
  <section>
    ...
    <section class="section_Body">
        ...
        <h1 style="margin-top:-10%" class="head">My Upcoming Appointment</h1>
...
<div  class="col-md-4">
            ...
            <p><?php echo"note:" .$appoi['noteA'];   ?></p></p>
